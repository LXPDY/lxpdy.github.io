import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as c,c as i,a as s,b as n,e,f as o}from"./app-a124689e.js";const l={},u=o(`<h1 id="objective-c学习日记" tabindex="-1"><a class="header-anchor" href="#objective-c学习日记" aria-hidden="true">#</a> Objective-C学习日记</h1><h2 id="_2023-10-10" tabindex="-1"><a class="header-anchor" href="#_2023-10-10" aria-hidden="true">#</a> 2023.10.10</h2><h3 id="objective-c-的存在" tabindex="-1"><a class="header-anchor" href="#objective-c-的存在" aria-hidden="true">#</a> Objective-C++的存在</h3><p>在<code>Xcode</code>中直接创建一个macOS的命令行工程，尝试在其中添加CPP代码</p><div class="language-objc line-numbers-mode" data-ext="objc"><pre class="language-objc"><code><span class="token comment">//test.mm</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>发现是无法在Xcode中直接编译运行的。对于混编代码，需要在<code>Xcode</code>侧边栏将文件扩展名更改为<code>.mm</code>类型后选择<code>Objective-C</code>的类型才行。</p><p>Objc的代码中可以直接<code>import</code>C++的头文件，调用C++的函数来实现逻辑。但是Objc的原生类方法声明实现风格和C++书写风格迥异。</p><p>经过测试，Objc的文件也可以直接使用C++头文件中的类以及声明的函数，只需要在编译时选定它为Objc++的类型。</p><p>甚至stl容器都能支持Objc的对象和数据类型，给人一种诡异的感觉：<em><strong><s>就好像甜咸豆腐脑混在一起，蜜枣粽里面夹肉</s></strong></em>；</p><h2 id="_2023-10-12" tabindex="-1"><a class="header-anchor" href="#_2023-10-12" aria-hidden="true">#</a> 2023.10.12</h2><h3 id="objective-c-block-objc版本的lambda表达式-block作返回值" tabindex="-1"><a class="header-anchor" href="#objective-c-block-objc版本的lambda表达式-block作返回值" aria-hidden="true">#</a> Objective-C Block，Objc版本的lambda表达式？block作返回值</h3><div class="language-objc line-numbers-mode" data-ext="objc"><pre class="language-objc"><code><span class="token keyword">typedef</span> <span class="token keyword">void</span> <span class="token punctuation">(</span><span class="token operator">^</span>SeleFunc<span class="token punctuation">)</span><span class="token punctuation">(</span><span class="token keyword">int</span> n<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h5><p>关于这部分，还有很多代码和细节没有去深究，毕竟还是在初学阶段（<s>其实还是偷懒+看不懂</s>），但是研究过后，还是不得不佩服苹果在这方面做出的细节，对于一个计算机的学生来说，这部分代码即是只是一个程序的内存管理系统，但是俨然已经很像一个完备的操作系统的内存管理系统。这部分，其实很像java的JVM系列的自动管理。</p><p>另：</p><p><code>not available in automatic reference counting mode</code>在学习的过程中发现了这个报错，发现现在高版本的Xcode的编译选项中已经自带引用计数器了，不需要程序员进行初始化</p><h3 id="nserror" tabindex="-1"><a class="header-anchor" href="#nserror" aria-hidden="true">#</a> NSError</h3><h4 id="注册方法" tabindex="-1"><a class="header-anchor" href="#注册方法" aria-hidden="true">#</a> 注册方法</h4><div class="language-objc line-numbers-mode" data-ext="objc"><pre class="language-objc"><code>      NSString <span class="token operator">*</span>domain <span class="token operator">=</span> <span class="token string">@&quot;com.MyCompany.MyApplication.ErrorDomain&quot;</span><span class="token punctuation">;</span>
      NSString <span class="token operator">*</span>desc <span class="token operator">=</span><span class="token string">@&quot;Unable to complete the process&quot;</span><span class="token punctuation">;</span>
      NSDictionary <span class="token operator">*</span>userInfo <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token punctuation">[</span>NSDictionary alloc<span class="token punctuation">]</span> 
      initWithObjectsAndKeys<span class="token punctuation">:</span>desc<span class="token punctuation">,</span>
      <span class="token string">@&quot;NSLocalizedDescriptionKey&quot;</span><span class="token punctuation">,</span><span class="token constant">NULL</span><span class="token punctuation">]</span><span class="token punctuation">;</span>  
      <span class="token operator">*</span>errorPtr <span class="token operator">=</span> <span class="token punctuation">[</span>NSError errorWithDomain<span class="token punctuation">:</span>domain code<span class="token punctuation">:</span><span class="token operator">-</span><span class="token number">101</span> userInfo<span class="token punctuation">:</span>userInfo<span class="token punctuation">]</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><code>domain</code> 错误发生域</li><li><code>userInfo</code>错误详细描述</li><li><code>code</code>错误码</li></ul><p>除了通过错误码来访问相关错误信息，NSError还提供了对应的只读属性来直接读取相关信息。当创建 error 对象时，可以在userinfo中提供这些功能。</p><p>不太用过这样的报错体系，希望后面学的更多能回来补充。</p><h2 id="_2023-10-17" tabindex="-1"><a class="header-anchor" href="#_2023-10-17" aria-hidden="true">#</a> 2023.10.17</h2><h4 id="分类-category-和扩展-extension" tabindex="-1"><a class="header-anchor" href="#分类-category-和扩展-extension" aria-hidden="true">#</a> 分类(Category)和扩展(Extension)</h4><ul><li><p>为一个已有的类添加新功能</p></li><li><p>通常分类的声明会放在单独的头文件中, 实现的代码也会放置在单独的源码文件中【虽然从分类中添加的方法对于它所有的实例以及子类实例都可见, 但是我们在使用这些方法时, 仍然是需要引入对应头文件的】</p></li><li><p>我们也可以使用分类将一个复杂的类的实现分开成多个文件管理</p></li><li><p>分类可以用来声明实例方法或者类方法, 但是大多数情况下不适宜声明额外的属性. 虽然从语法角度看在分类的声明中声明属性是可行的, 但是却不能够在分类中声明额外的实例变量</p></li><li><p>类扩展（匿名分类）【只能添加到在编译时拥有源代码的类】</p><ul><li>和普通分类不同的是, 类扩展可以为类添加属性和实例变量</li><li>通过在一个类的实现文件中添加类扩张，可以将一些类的属性在单文件内公开，但是不影响其他外部引用</li></ul></li></ul>`,29);function h(g,f){const a=p("ExternalLinkIcon");return c(),i("div",null,[u,s("p",null,[n("看了几篇文章"),s("a",d,[n("Objective-C的本质"),e(a)]),n("、"),s("a",r,[n("OC对象的前世今生"),e(a)]),n("、 "),s("a",k,[n("自动释放池"),e(a)])]),v,s("p",null,[s("a",m,[n("IOS - 聊聊 autorelease 和 @autoreleasepool"),e(a)])]),b])}const O=t(l,[["render",h],["__file","Object-C学习日记.html.vue"]]);export{O as default};
