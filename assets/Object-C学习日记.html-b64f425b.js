import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as c,c as i,a as s,b as n,e,f as o}from"./app-0e3b13b8.js";const l={},u=o(`<h1 id="object-c学习日记" tabindex="-1"><a class="header-anchor" href="#object-c学习日记" aria-hidden="true">#</a> Object-C学习日记</h1><h2 id="_2023-10-10" tabindex="-1"><a class="header-anchor" href="#_2023-10-10" aria-hidden="true">#</a> 2023.10.10</h2><h3 id="object-c-的存在" tabindex="-1"><a class="header-anchor" href="#object-c-的存在" aria-hidden="true">#</a> Object-C++的存在</h3><p>在<code>Xcode</code>中直接创建一个macOS的命令行工程，尝试在其中添加CPP代码</p><div class="language-objc line-numbers-mode" data-ext="objc"><pre class="language-objc"><code><span class="token comment">//test.mm</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>发现是无法在Xcode中直接编译运行的。对于混编代码，需要在<code>Xcode</code>侧边栏将文件扩展名更改为<code>.mm</code>类型后选择<code>Objec-C++</code>的类型才行。</p><p>Objc的代码中可以直接<code>import</code>C++的头文件，调用C++的函数来实现逻辑。但是Objc的原生类方法声明实现风格和C++书写风格迥异。</p><p>经过测试，Objc的文件也可以直接使用C++头文件中的类以及声明的函数，只需要在编译时选定它为Objc++的类型。</p><p>甚至stl容器都能支持Objc的对象和数据类型，给人一种诡异的感觉：<em><strong><s>就好像甜咸豆腐脑混在一起，蜜枣粽里面夹肉</s></strong></em>；</p><h2 id="_2023-10-12" tabindex="-1"><a class="header-anchor" href="#_2023-10-12" aria-hidden="true">#</a> 2023.10.12</h2><h3 id="object-c-block-objc版本的lambda表达式-block作返回值" tabindex="-1"><a class="header-anchor" href="#object-c-block-objc版本的lambda表达式-block作返回值" aria-hidden="true">#</a> Object-C Block，Objc版本的lambda表达式？block作返回值</h3><div class="language-objc line-numbers-mode" data-ext="objc"><pre class="language-objc"><code><span class="token keyword">typedef</span> <span class="token keyword">void</span> <span class="token punctuation">(</span><span class="token operator">^</span>SeleFunc<span class="token punctuation">)</span><span class="token punctuation">(</span><span class="token keyword">int</span> n<span class="token punctuation">)</span><span class="token punctuation">;</span>
